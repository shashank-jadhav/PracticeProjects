...
public class JavaDropbox {
	...
	private static final String DROP_BOX_APP_KEY = "me2v9v803a21980";
	private static final String DROP_BOX_APP_SECRET = "57fvb8pouv1nltf";
	DbxClient dbxClient;
	...
	public void downloadFromDropbox(String fileName) throws DbxException, IOException {//output file for download --> storage location on local system to download file
        OutputStream downloadFile = new FileOutputStream("C:\\.....");
        try
        {
        FileMe metadata = dbxClient.files().downloadBuilder("/root or foldername here/Koala.jpg")
