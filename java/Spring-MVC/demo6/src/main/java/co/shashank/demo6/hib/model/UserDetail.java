package co.shashank.demo6.hib.model;
...
@Entity
@NamedQueries({ @NamedQuery(name = "GET_USER_DETAILS", query = "SELECT NEW co.nworks.demo6.dto.UserDetailOut( ud.userId , ud.email ) FROM UserDetail ud WHERE ud.email = :suppliedEmail")
,
