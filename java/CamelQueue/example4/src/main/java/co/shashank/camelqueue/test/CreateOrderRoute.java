...
/**
 * A simple route that routes orders from the file system to the ActiveMQ
 * newOrder queue.
 */
public class CreateOrderRoute extends RouteBuilder {
	...
	public void configure() throws Exception {
		// route files form src/data (noop = keep the file as-is after done, and
		// do not pickup the same file again)
